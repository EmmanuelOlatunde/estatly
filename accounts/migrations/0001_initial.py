    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('ESTATE_MANAGER', 'Estate Manager'), ('REGULAR', 'Regular')], db_index=True, default='ESTATE_MANAGER', max_length=20)),
